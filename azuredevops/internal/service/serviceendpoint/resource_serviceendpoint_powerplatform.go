...
// ResourceServiceEndpointPowerPlatform schema and implementation for Power Platform service endpoint resource
func ResourceServiceEndpointPowerPlatform() *schema.Resource {
	r := genBaseServiceEndpointResource(flattenServiceEndpointPowerPlatform, expandServiceEndpointPowerPlatform)
...
func expandServiceEndpointPowerPlatform(d *schema.ResourceData) (*serviceendpoint.ServiceEndpoint, *string, error) {
	...
	serviceEndpoint.Type = converter.String("powerplatform")
	serviceEndpoint.Url = converter.String("https://management.azure.com/")
	return serviceEndpoint, projectID, nil
}

func expandSpnKeyServiceEndpointPowerPlatform(credentials map[string]interface{}) string {
...
func flattenCredentialsServiceEndpointPowerPlatform(serviceEndpoint *serviceendpoint.ServiceEndpoint, hashKey string, hashValue string) interface{} {
...
func flattenServiceEndpointPowerPlatform(d *schema.ResourceData, serviceEndpoint *serviceendpoint.ServiceEndpoint, projectID *string) {
